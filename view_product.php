            ...
            <div class="col-md-6">
                ...
                <form action="" id="add-cart">
                    <div class="d-flex align-items-center">
                        <!-- Hidden inputs for price and inventory_id (if needed) -->
                        <input class="form-control text-center me-3" id="inputQuantity" type="number" value="1" style="max-width: 3rem" name="quantity" />

                        <!-- Shopee button -->
                        <a href="<?php echo $shopee_link; ?>" target="_blank" class="btn btn-outline-danger btn-sm me-2" title="Shop on Shopee">
                            <img src="assets/images/shopee.png" alt="Shopee" style="width: 20px; height: 20px;">
                        </a>

                        <!-- Lazada button -->
                        <a href="<?php echo $lazada_link; ?>" target="_blank" class="btn btn-outline-primary btn-sm me-2" title="Shop on Lazada">
                            <img src="assets/images/lazada.jpg" alt="Lazada" style="width: 20px; height: 20px;">
                        </a>

                        <!-- TikTok button -->
                        <a href="<?php echo $tiktok_link; ?>" target="_blank" class="btn btn-outline-dark btn-sm" title="Shop on TikTok">
                            <img src="assets/images/tiktok.png" alt="TikTok" style="width: 20px; height: 20px;">
                        </a>
                    </div>
                </form>
